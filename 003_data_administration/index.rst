.. _data_administration:

==============
SPADE Data Administration
==============
This section will teach how to use the `GeoNode <http://geonode.org/>`_ going in depth into what we can do with software application.
...
.. toctree::
    ...
    007_managing_remote_services/index
    008_using_geonode_w_other_applications/index
...
:ref:`document_types`
    GeoNode welcome page shows a variety of information about the current GeoNode instance. At the top of the page is a toolbar showing quick links to document types: layers, maps, documents and remote services.
...
:ref:`remote_services`
    Create, delete, manage and share Remote Services on GeoNode.
